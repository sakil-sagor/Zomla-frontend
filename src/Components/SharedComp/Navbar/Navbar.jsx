...
import ProfileShortcut from "../../FrontendComponent/ProfileShortcut/ProfileShortcut";
import "./Navbar.css";
                ...
                >
                  <div className="flex flex-col lg:flex-row list-none lg:ml-auto items-center	">
                    <div className="nav-item">
                      <NavLink
                        className="manu-item p-2  font-semibold text-block "
                        to="/"
                      >
                        Home
                      </NavLink>
                    ...
                    <div className="nav-item">
                      <NavLink
                        ...
                        to="/addToCart"
                      >
                        <i className="fas fa-cart-plus text-block  text-2xl font-bold"></i>
                      </NavLink>
                    </div>
                    <div className="profile-holder py-3 ml-4">
                      {user.email || user.displayName ? (
                        ...
                        <NavLink
                          className="manu-item p-2 text-lg font-bold text-indigo-900 bg-white hover:text-pink-800 text-block rounded-md"
                          to="/login"
                        >
                          LogIn{" "}
                        </NavLink>
