...
import PageTitle from "../../../Components/SharedComp/PageTitle/PageTitle";
import "./Login.css";
        ...
        <div className="col-span-12 sm:col-span-8 md:col-span-6 ">
          ...
          <div>
            <p className="text-red-600 font-semibold py-4">
              {errorLogin === "Firebase: Error (auth/user-not-found)."
          ...
          <div className="w-full">
            <form onSubmit={handelLogin}>
              ...
              <input
                type="text"
                // type="submit"
                className="cursor-pointer text-base block font-bold text-white px-4 py-2 uppercase bg-indigo-900 hover:bg-indigo-800
radiou rounded-sm "
                value="login"
              />
            </form>
            <NavLink
              className="text-pink-700 font-bold underline text-right block forget-link hover:text-pink-900 hover:no-underline"
              to="/forgatePass"
            >
              Forget password?
            </NavLink>
          ...
          <div className="flex mt-8 login-btn">
            <button
              ...
              className="mr-2 text-base block font-bold text-white px-4 py-2 bg-indigo-900 hover:bg-indigo-800
radiou rounded-sm "
            >
              Google Login
            </button>
